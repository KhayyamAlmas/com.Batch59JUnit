...
public class C02_handleWindows {
    ...
    public void test(){
        ...
        // 3- yeni bir pencere acip duolingo ana sayfaya gidelim
        driver.switchTo().newWindow(WindowType.WINDOW);
        driver.get("https://www.duolingo.com/");
        String ikinciSayfaHandleDegeri= driver.getWindowHandle();

        // 4- title'in Duolingo icerdigini test edelim
        String actualTitle= driver.getTitle();
        String arananKelime="Duolingo";
        ...
        WebElement logoElementi=driver.findElement(By.xpath("//div[@class='_2eTYC']"));
