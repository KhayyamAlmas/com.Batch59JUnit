...
public class C06_ReadExcel {
    ...
    public void readExcelTest() throws IOException {
        // excel dosyasindaki tum verileri clasimiza laip
        // bir Java objesine store edelim
        // boylece her seferinde  excel'e ulasip satir, sutun ve s... ugrasmayalim
        ...
        for (int i = 0; i <=sonSatirIndex ; i++) {
            ...
            // key i. satirdaki 0 index'indeki data olacak
